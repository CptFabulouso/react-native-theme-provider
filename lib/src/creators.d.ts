...
export declare function initThemeProvider<T extends Themes, BSKey extends string = 'bs', BS extends Styles<BS> = undefined, TP = undefined>({ themes, initialTheme, onThemeChange, onThemeParamsChange, styleCacheManager, baseStylesCreator, initialThemeParams, baseStylesKey, }: InitThemeProviderParams<T, BS, BSKey, TP>): {
    ...
    } & Partial<ThemeContextProps<T, BS, BSKey, TP>>) => JSX.Element;
    ThemedProviderComponent: React.FunctionComponent<ThemeContextProps<T, BS, BSKey, TP>>;
    ...
    useTheme: () => ThemeContextValue<T, TP>;
