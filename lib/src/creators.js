...
function initThemeProvider({ themes, initialTheme, onThemeChange, onThemeParamsChange, styleCacheManager = createThemedDefaultCacheManager(), baseStylesCreator, initialThemeParams, baseStylesKey = 'bs', themeKey = 't', }) {
    const ThemedThemedProvider = ({ children, onThemeChange: propsOnThemeChange, onThemeParamsChange: propsOnThemeParamsChange, initialTheme: propsInitialTheme, baseStylesCreator: propsBaseStylesCreator, initialThemeParams: propsInitialThemeParams, themeKey: propsThemeKey, baseStylesKey: propsBaseStylesKey, }) => {
        ...
        return (<ThemeContext_1.ThemeProvider initialTheme={propsInitialTheme ?? initialTheme} themes={themes} onThemeChange={handleThemeChange} onThemeParamsChange={handleThemeParamsChange} baseStylesCreator={propsBaseStylesCreator ?? baseStylesCreator} baseStylesKey={propsBaseStylesKey ?? baseStylesKey} initialThemeParams={propsInitialThemeParams ?? initialThemeParams} themeKey={propsThemeKey ?? themeKey}>
        {children}
