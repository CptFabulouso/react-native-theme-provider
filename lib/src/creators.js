...
function initThemeProvider({ themes, initialTheme, onThemeChange, onThemeParamsChange, styleCacheManager = createThemedDefaultCacheManager(), baseStylesCreator, initialThemeParams, baseStylesKey = 'bs', }) {
