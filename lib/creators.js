...
exports.initThemeProvider = exports.createThemedUseStyleCreator = exports.createThemedStyleCreator = exports.createUseStyle = exports.createStyle = exports.createStyleCreator = exports.createThemedDefaultCacheManager = exports.createThemedUseThemeDispatch = exports.createThemedUseTheme = void 0;
...
function initThemeProvider({ themes, initialTheme, onThemeChange, styleCacheManager = createThemedDefaultCacheManager(), }) {
    const ThemedThemedProvider = ({ children, onThemeChange: propsOnThemeChange, initialTheme: propsInitialTheme, }) => {
        React.useEffect(() => {
        ...
        return (<ThemeContext_1.ThemeProvider initialTheme={propsInitialTheme ?? initialTheme} themes={themes} onThemeChange={handleThemeChange}>
        {children}
