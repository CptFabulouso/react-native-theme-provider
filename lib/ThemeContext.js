...
function ThemeProvider({ children, initialTheme, onThemeChange, onThemeParamsChange, themes, baseStylesCreator, initialThemeParams, styleCacheManager = (0, creators_1.createThemedDefaultCacheManager)(), }) {
    ...
    return (<exports.ThemeContext.Provider value={{ selectedTheme: themeName, themes, t, themeParams }}>
      <exports.ThemeBaseStylesContext.Provider value={{ baseStyles }}>
